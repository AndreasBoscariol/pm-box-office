...
try:
    from scripts.db import connect_database, database_url_from_env, insert_ignore_sql
except ModuleNotFoundError:  # Allow `python3 scripts/ingest/ingest_wikipedia_boxoffice.py`.
