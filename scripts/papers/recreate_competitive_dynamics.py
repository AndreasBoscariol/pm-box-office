...
Default run:
    python3 scripts/papers/recreate_competitive_dynamics.py
"""
...
try:
    from scripts.db import connect_database, database_url_from_env, table_names
except ModuleNotFoundError:  # Allow `python3 scripts/papers/recreate_competitive_dynamics.py`.
