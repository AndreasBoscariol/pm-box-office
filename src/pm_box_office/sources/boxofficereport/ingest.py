...
def initialize_database(conn: Any) -> None:
    conn.executescript(
        ...
        CREATE INDEX IF NOT EXISTS idx_boxofficereport_predictions_movie
            ON boxofficereport_weekend_predictions(matched_movie_id);
    ...
    *,
    ...
    conn.executemany(
        ...
        INSERT INTO boxofficereport_weekend_predictions (
            ...
            row_ordinal, matched_movie_id, match_status, match_method, match_score,
...
def upsert_movie_source_id(
    ...
    *,
    ...
    conn.execute(
        ...
        VALUES (%s, 'boxofficereport', %s, %s, %s, %s, %s, CURRENT_TIMESTAMP)
